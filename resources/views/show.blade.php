    ...
    <div class="container mx-auto px-4">
            ...
            <div class="ml-12 mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-xs ml-12">Member <br> Score</div>
                    </div>
                    <div class="flex items-center">
                        <div class="w-16 h-16 bg-gray-800 rounded-full">
                            <div class="font-semibold text-xs flex justify-center items-center h-full">
                ...
                <div class="mt-12">
                    <button class="flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bl-blue-600 rounded transition easi-in-out duration-150">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="">
                        <img src="/test.jpg" alt="screenshot" class="hover:opacity-75 transition easi-in-out duration-150">
                    </a>
                </div>
            </div>
        </div>
